...
Fase 11 v1 (diagnostica reale: errori non gestiti persistiti + report).**
...
reale), **chat reale con l'Assistente AI** (stesso provider configurato, senza
ancora poter leggere/modificare il workflow), **libreria Personaggi** (CRUD +
