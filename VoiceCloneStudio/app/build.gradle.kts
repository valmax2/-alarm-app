...
android {
    namespace = "it.vstudioapps.voiceclonestudio"
    compileSdk = 35

    defaultConfig {
        applicationId = "it.vstudioapps.voiceclonestudio"
        minSdk = 26
        targetSdk = 35
        ...
        // Surfaced in Impostazioni so testers can confirm exactly which build is installed,
...
dependencies {
    ...
    // Persisted user preferences (default model, default voice-generation settings).
    implementation("androidx.datastore:datastore-preferences:1.1.1")

    // Stores the ElevenLabs API key encrypted at rest instead of in plain SharedPreferences.
    implementation("androidx.security:security-crypto:1.1.0-alpha06")

    // Talks to the ElevenLabs REST API (voice cloning + text-to-speech + speech-to-speech).
